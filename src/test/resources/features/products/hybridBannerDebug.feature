Feature: Debug feature banner
  ...
  ->> Erotic content filter - To remove adult content from banner
...
#  - Pinned Tile 3,3 position
#  - Pinned Tile 1,2 position
#  - Pinned Tile 1,3 position
#  - Dynamic Sports Tile 10 position
#  tlxsta_225h79991767071939478 - Static Sports Tile n position
#  - Collection With No Pinned Tile
