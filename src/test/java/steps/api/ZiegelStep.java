...
import model.response.ziegel.TileEntity;
...
public class ZiegelStep {
    ...
    public void verifyTheTileBehaveAsBroadbandUpSellTileOnTheBanner() {
        ...
        Assert.assertEquals(TileEntity.LOCAL_TILE, res1.getEntity());
        Assert.assertEquals(res1.getEntityId(), res1.getTileId());
        Assert.assertFalse(res1.getThumbnailUrlJson().isEmpty());
