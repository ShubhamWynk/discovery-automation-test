...
public class ArsenalService extends BaseServiceClient {
    ...
    public  Response getDiscoveryArsenalCollection(String collectionId, Map<String,String> query) {
    ...
    public  ArsenalCollection getArsenalCollectionController(String collectionId, Map<String,String> liveAttribute) {
    ...
    public  ArsenalCollectionResponse getArsenalCollectionControllerResponse(String collectionId, Map<String,String> liveAttribute) {
        Response response = getDiscoveryArsenalCollection(collectionId, liveAttribute);
        Assert.assertEquals(200, response.getStatusCode());
